...
struct ShapesAndColorsMenu: View {
    static let activities: [LearningActivity] = [
        ...
        .init(id: "shapes.reveal", title: "Rainbow Windows", skill: "Connect color words and objects", interaction: "Explore twelve rounds of surprise windows, color clues, and shape matching", ageBand: "2–4 with a grown-up", caregiverTip: "Ask which color your child wants to explore next."),
