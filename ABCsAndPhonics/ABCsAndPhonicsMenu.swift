...
struct ABCsAndPhonicsMenu: View {
    static let activities: [LearningActivity] = [
        ...
        .init(id: "phonics.food-scroll", title: "Picnic Words", skill: "Listen and remember familiar words", interaction: "Choose three requested foods from six pictures, in any order", ageBand: "Ages 2–4", caregiverTip: "Tap each labeled basket to hear its food. Pack the three foods in any order."),
