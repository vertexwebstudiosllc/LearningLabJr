...
| Counting Drum | Watch three differently sized drums light up, then copy the order; mistakes automatically replay the example, which remains visible | 18 randomized patterns, growing from 2 to 7 beats |
